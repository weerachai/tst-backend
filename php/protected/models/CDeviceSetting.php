...
/**
 * This is the model class for table "cDeviceSetting".
 *
 * The followings are the available columns in table 'cDeviceSetting':
 ...
 */
class CDeviceSetting extends CActiveRecord
{
	/**
	 * Returns the static model of the specified AR class.
	 * @param string $className active record class name.
	 * @return CDeviceSetting the static model class
	 */
	...
	public function rules()
	{
		...
		return array(
			...
			array('SaleId, PromotionSku, PromotionGroup, PromotionBill, PromotionAccu, Vat', 'length', 'max'=>255),
			array('OverStock', 'length', 'max'=>1),
			array('UpdateAt', 'safe'),
			// The following rule is used by search().
			// Please remove those attributes that should not be searched.
			array('SaleId, PromotionSku, PromotionGroup, PromotionBill, PromotionAccu, Vat, OverStock, DayToClear, UpdateAt', 'safe', 'on'=>'search'),
		);
	}
