...
/**
 * This is the model base class for the table "RequestDetail".
 * DO NOT MODIFY THIS FILE! It is automatically generated by giix.
 * If any changes are necessary, you must set or override the required
 * property or method in class "RequestDetail".
 *
 * Columns in table "RequestDetail" available as properties of the model,
 * followed by relations of table "RequestDetail" available as properties of the model.
 *
 ...
 */
abstract class BaseRequestDetail extends GxActiveRecord {
	...
	public static function label($n = 1) {
		return Yii::t('app', 'RequestDetail|RequestDetails', $n);
	}
