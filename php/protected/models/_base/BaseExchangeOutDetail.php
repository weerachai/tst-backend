...
/**
 * This is the model base class for the table "ExchangeOutDetail".
 * DO NOT MODIFY THIS FILE! It is automatically generated by giix.
 * If any changes are necessary, you must set or override the required
 * property or method in class "ExchangeOutDetail".
 *
 * Columns in table "ExchangeOutDetail" available as properties of the model,
 * followed by relations of table "ExchangeOutDetail" available as properties of the model.
 *
 ...
 */
abstract class BaseExchangeOutDetail extends GxActiveRecord {
	...
	public static function label($n = 1) {
		return Yii::t('app', 'ExchangeOutDetail|ExchangeOutDetails', $n);
	}
