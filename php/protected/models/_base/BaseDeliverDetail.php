...
/**
 * This is the model base class for the table "DeliverDetail".
 * DO NOT MODIFY THIS FILE! It is automatically generated by giix.
 * If any changes are necessary, you must set or override the required
 * property or method in class "DeliverDetail".
 *
 * Columns in table "DeliverDetail" available as properties of the model,
 * followed by relations of table "DeliverDetail" available as properties of the model.
 *
 ...
 */
abstract class BaseDeliverDetail extends GxActiveRecord {
	...
	public static function label($n = 1) {
		return Yii::t('app', 'DeliverDetail|DeliverDetails', $n);
	}
	...
	public function rules() {
		return array(
			...
			array('UpdateAt', 'safe'),
			array('DeliverNo, ProductId, QtyLevel1, QtyLevel2, QtyLevel3, QtyLevel4, PriceLevel1, PriceLevel2, PriceLevel3, PriceLevel4, UpdateAt', 'default', 'setOnEmpty' => true, 'value' => null),
	...
	public function search() {
		...
		$criteria->compare('DeliverNo', $this->DeliverNo);
