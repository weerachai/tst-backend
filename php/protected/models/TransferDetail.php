...
/**
 * This is the model class for table "TransferDetail".
 *
 * The followings are the available columns in table 'TransferDetail':
 ...
 */
class TransferDetail extends CActiveRecord
{
	/**
