...
/**
 * This is the model class for table "ControlRunning".
 *
 * The followings are the available columns in table 'ControlRunning':
...
class ControlRunning extends CActiveRecord
{
	 ...
	 * @return ControlRunning the static model class
	 */
