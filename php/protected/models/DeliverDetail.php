...
/**
 * This is the model class for table "DeliverDetail".
 *
 * The followings are the available columns in table 'DeliverDetail':
 ...
 * @property StockDeliver $deliverNo
 */
class DeliverDetail extends CActiveRecord
{
	/**
	 * Returns the static model of the specified AR class.
	 * @param string $className active record class name.
	 * @return DeliverDetail the static model class
	 */
	...
	public function rules()
	{
		...
		return array(
			...
			array('DeliverNo, ProductId', 'length', 'max'=>255),
			array('PriceLevel1, PriceLevel2, PriceLevel3, PriceLevel4', 'length', 'max'=>10),
			array('UpdateAt', 'safe'),
			// The following rule is used by search().
			// Please remove those attributes that should not be searched.
			array('DeliverNo, ProductId, QtyLevel1, QtyLevel2, QtyLevel3, QtyLevel4, PriceLevel1, PriceLevel2, PriceLevel3, PriceLevel4, UpdateAt', 'safe', 'on'=>'search'),
		);
	}
	...
	public function relations()
	{
		...
		return array(
			'deliverNo' => array(self::BELONGS_TO, 'StockDeliver', 'DeliverNo'),
		);
	}
