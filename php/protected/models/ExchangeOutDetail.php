...
/**
 * This is the model class for table "ExchangeOutDetail".
 *
 * The followings are the available columns in table 'ExchangeOutDetail':
 ...
 */
class ExchangeOutDetail extends CActiveRecord
{
	/**
	 * Returns the static model of the specified AR class.
	 * @param string $className active record class name.
	 * @return ExchangeOutDetail the static model class
	 */
